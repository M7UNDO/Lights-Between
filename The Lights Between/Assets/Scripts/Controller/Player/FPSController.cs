...
public class FPSController : MonoBehaviour
{
    ...
    {
        SimpleTutorialPromptManager.OnTutorialStarted += EvaluateHUDState;
        SimpleTutorialPromptManager.OnTutorialEnded += EvaluateHUDState;
    }
    ...
    public void EvaluateHUDState()
    {
        if (hudCanvas == null) return;

        bool shouldShowHUD = !SimpleTutorialPromptManager.IsTutorialActive
                          && !isInspecting
                          && !isInMiniGame
                          && !isJumpscareActive
                          && !GameLoopManager.IsGameEnded;

        if (hudCanvas.gameObject.activeSelf != shouldShowHUD)
        {
